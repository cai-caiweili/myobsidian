---
{"dg-publish":true,"aliases":null,"tags":null,"title":"obsidian插件推荐","permalink":"/0801 学习笔记/obsidian/obsidian插件/obsidian插件推荐/","dgPassFrontmatter":true,"noteIcon":""}
---
...
### obsidian-admonition
在 Obsidian 中插入很好看的标识文本，写过相关的文章：[Obsidian 插件之 Admonition - 知乎](https://zhuanlan.zhihu.com/p/391252867)；在 Callout 功能出来以后，这个插件逐渐变成了单纯的插入 Callout 的更方便的插件。
### obsidian-banners
...
### quickadd
新一代的快速裁剪、添加或命令顺序执行插件，之前写过相关文章：[Obsidian 插件之 QuickAdd - 知乎](https://zhuanlan.zhihu.com/p/386885976) 。一年多过去了，这个插件已经成为了我日常生活中不可或缺的插件之一。
### obsidian-table-generator
